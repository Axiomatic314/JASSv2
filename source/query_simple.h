...
/*!
	@file
	@brief Everything necessary to process a query using an array of accumulators with no special handeling
...
namespace JASS
	...
	*/
	class query_simple : public query
		{
		private:
		...
		public:
			...
			*/
			/*!
				@brief Clear this object after use and ready for re-use in a new query
			*/
			...
			*/
			...
			/*
				QUERY_SIMPLE::DECODE_WITH_WRITER()
				----------------------------------
			*/
			/*!
			...
			*/
			static void unittest(void)
				...
				query_simple *query_object = new query_simple(codex);
