...
class JASS_anytime_thread_result
	...
	public:
		...
		*/
		void push_back(const std::string &query_id, const std::string &query, const std::string &results_list, size_t postings_processed, size_t search_time_in_ns, const std::string accumulator_manager)
			{
			results[query_id] = JASS_anytime_result(query_id, query, results_list, postings_processed, search_time_in_ns, accumulator_manager);
			}
